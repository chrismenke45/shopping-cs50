...
def load_data(filename):
    ...
    with open(filename) as f:
        ...
        for row in reader:
            ...
            row_evidence.append(int(MONTH_ABBREV_TO_NUM[row["Month"]]))
            ...
            row_evidence.append(int(1 if row["VisitorType"] == "Returning_Visitor" else 0))
            row_evidence.append(int(1 if row["Weekend"] == "TRUE" else 0))
...
def evaluate(labels, predictions):
    ...
    positive_rate = positive_correct_count / positive_count
    negative_rate = negative_correct_count / negative_count
